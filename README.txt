...
The photoldr module parses post data and updates or creates nodes.
...
* Select the Icon style.  This should be thumbnail or some other small
  image style.  Preferably 100x100 pixels or smaller.
...
* Set the node type weights.  The weighs must be different, or a type
  may not display.

* Specify settings per node type: Max Items, Max Age per item, Sort
  Order, and Sort By.
